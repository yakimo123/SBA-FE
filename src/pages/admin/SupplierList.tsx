...
const css = `
  ...
  .sl-add-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(201,82,26,0.38); }
  ...
  .sl-search:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(201,82,26,0.12); }
  ...
  .sl-btn-delete:hover { background: var(--danger-soft); border-color: #f5c2c2; }
  ...
  .sl-input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(201,82,26,0.12); }
  .sl-form-error {
    display: flex; align-items: center; gap: 8px;
    background: var(--danger-soft); border: 1px solid #f5c2c2;
  ...
  .sl-btn-save:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 5px 16px rgba(201,82,26,0.38); }
