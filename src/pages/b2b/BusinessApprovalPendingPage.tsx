    ...
    switch (status) {
      ...
      case 'rejected':
        return {
          ...
          description: 'Rất tiếc, hồ sơ của bạn chưa đáp ứng yêu cầu',
          bgColor: 'bg-red-50',
          iconBg: 'bg-red-100',
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <Card className="shadow-lg mb-6">
          <CardHeader className={`text-center border-b ${statusInfo.bgColor}`}>
            <div
            ...
            <Badge className={`${statusInfo.badgeColor} mt-4`}>
              ...
              {status === 'need-documents' && 'CẦN BỔ SUNG'}
            </Badge>
          </CardHeader>
          <CardContent className="p-6">
            ...
            {status === 'pending' && (
              <Alert>
                ...
                <AlertDescription>
                  Thông thường mất 2-3 ngày làm việc để xét duyệt hồ sơ. Chúng
                  tôi sẽ gửi email thông báo kết quả đến bạn ngay khi hoàn tất.
                </AlertDescription>
              </Alert>
            )}
              ...
              <div className="space-y-4">
                <Alert className="border-green-200 bg-green-50">
                  ...
                  <AlertDescription className="text-green-800">
                    Vui lòng hoàn tất ký hợp đồng điện tử và cấu hình tài khoản
                    để bắt đầu sử dụng dịch vụ B2B.
                  </AlertDescription>
                </Alert>
                <Button
                  onClick={() => navigate('/business-contract')}
                ...
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>Giấy chứng nhận đăng ký kinh doanh không rõ ràng</li>
                      <li>Thông tin người đại diện không khớp với giấy tờ</li>
                    </ul>
                  </AlertDescription>
                </Alert>
                ...
                <Alert className="border-orange-200 bg-orange-50">
                  ...
                  <AlertDescription className="text-orange-800">
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Chứng minh tài chính (Sao kê ngân hàng 3 tháng gần nhất)
                      </li>
                      <li>
