...
const bannerService = {
  ...
  ): Promise<BannerAdminListResponse> => {
  ...
  getAdminBannerById: async (
    id: number
  ): Promise<BannerAdminDetailResponse> => {
    const response = await api.get<BannerAdminDetailResponse>(
  ...
  createBanner: async (
    ...
    const response = await api.post<BannerAdminDetailResponse>(
      '/api/admin/banners',
      banner
    );
    return response.data;
  ...
  updateBanner: async (
    ...
    const response = await api.put<BannerAdminDetailResponse>(
      `/api/admin/banners/${id}`,
      banner
    );
    return response.data;
  ...
  toggleBannerStatus: async (
    ...
    const response = await api.patch<BannerAdminDetailResponse>(
